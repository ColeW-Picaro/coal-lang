  ...
  public class CodeGenVisitor
  {
      ...
      for (int i = this.m_namedValues.Count - 1; i >= 0; --i)
      {
        ...
        if (value != null)
        {
          if (value.IsAAllocaInst != null && isRhs)
            return this.m_builder.BuildLoad2(value.TypeOf, value);
          return value;
        }
      }
      return null;
    ...
    public LLVMValueRef Visit(Ast.Expr.String s)
    {
      unsafe
      {
        ...
        return this.m_builder.BuildGEP2(str.TypeOf, str, ind);
      }
    ...
    public LLVMValueRef Visit(Ast.Expr.FuncCall f)
    {
      ...
      LLVMValueRef expr = this.m_builder.BuildCall2(fn.TypeOf, fn, args);
      return expr;
    }
